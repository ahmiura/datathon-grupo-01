...
from src.models.train import run_experiment, train
...
@patch("builtins.open")
@patch("src.models.train.mlflow")
def test_train_function(mock_mlflow, mock_open, mock_json, mock_save, mock_fetch, mock_snapshot, mock_preprocess, mock_run, mock_shutil):
